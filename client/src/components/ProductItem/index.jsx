...
const ProductItem = (props) => {
  ...
  return (
    <div className="productItem bg-white rounded-2xl overflow-hidden border border-[rgba(0,0,0,0.08)] hover:shadow-2xl transition-all duration-300 group">
      <div className="group imgWrapper w-[100%]  overflow-hidden  rounded-md rounded-bl-none rounded-br-none relative">
        <Link to={`/product/${props?.item?._id}`}>
          <div className="img h-[260px] md:h-[340px] overflow-hidden bg-[#f8f8f8] flex items-center justify-center">
            <img
      ...
      bg-[rgba(0,0,0,0.7)] z-[60] p-3 gap-2"
        ...
        <span className="discount flex items-center absolute top-[10px] left-[10px] z-50 bg-blue-500 text-white rounded-lg p-1 text-[12px] font-[500]">
          {props?.item?.discount}%
        </span>
        ...
        <div className="actions absolute top-[-20px] right-[5px] z-50 flex items-center gap-2 flex-col w-[50px] transition-all duration-300 group-hover:top-[15px] opacity-0 group-hover:opacity-100">
          <Button
            className="!w-[35px] !h-[35px] !min-w-[35px] !rounded-full !bg-white  text-black hover:!bg-blue-500 hover:text-white group"
            onClick={() =>
          ...
          <Button className="!w-[35px] !h-[35px] !min-w-[35px] !rounded-full !bg-white  text-black hover:!bg-blue-500 hover:text-white group">
          ...
          >
            {isAddedInMyList === true ? (
              <IoMdHeart className="text-[18px] !text-blue-500 group-hover:text-white hover:!text-white" />
            ) : (
      ...
      <div className="info p-4 relative pb-[65px] min-h-[180px]">
        <h6 className="text-[13px] !font-[400]">
          <span className="link transition-all">{props?.item?.brand}</span>
        </h6>
        <h3 className="text-[15px] lg:text-[16px] title mt-2 font-[600] mb-2 text-[#111] leading-[22px]">
          <Link
        ...
        <div className="flex items-center gap-4 justify-between">
          ...
          <span className="price text-blue-500 text-[16px] lg:text-[18px] font-[700]">
        ...
        <div className="!absolute bottom-[15px] left-0 pl-3 pr-3 w-full">
          {isAdded === false ? (
            <Button
              className="!bg-blue-500 !text-white addToCartBtn btn-border flex w-full btn-sm gap-2 "
              size="small"
              onClick={() =>
