      ...
      <nav className="navigation hidden md:block">
        <div className="container flex items-center justify-start lg:justify-end gap-8">
          <div className="col_2 w-full ">
            <ul className="flex items-center gap-5 xl:gap-7 nav">
              <li className="list-none">
                <Link to="/" className="link transition text-[14px] font-[500]">
                  <Button className="link transition !font-[600] !text-[16px] !px-5 !py-4 !rounded-lg !text-[rgba(0,0,0,0.85)] hover:!text-[#ff5252] hover:!bg-[#fff1f1]">
                    Home
                  </Button>
                </Link>
              </li>
                  ...
                  return (
                    <li className="list-none relative" key={index}>
                      <Link
                        ...
                        className="link transition text-[16px] font-[600]"
                      >
                        <Button className="link transition !font-[600] !text-[16px] !px-5 !py-4 !rounded-lg !text-[rgba(0,0,0,0.85)] hover:!text-[#ff5252] hover:!bg-[#fff1f1]">
                          {cat?.name}
                        </Button>
                              ...
                              return (
                                ...
                                >
                                  <Link
                                    ...
                                    className="w-full"
                                  >
                                    <Button className="!text-[15px] !font-[500] !text-[rgba(0,0,0,0.85)] w-full !text-left !justify-start !rounded-none !py-3 !px-4 hover:!bg-[#f8f8f8]">
                                      {subCat?.name}
                                    </Button>
