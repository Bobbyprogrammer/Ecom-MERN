...
import { addLogo, deleteLogo, getLogo, getLogoById, removeImageFromCloudinary, updatedLogo, uploadImages } from '../controllers/logo.controller.js';
...
logoRouter.delete('/:id', auth, deleteLogo);
