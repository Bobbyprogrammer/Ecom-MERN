                                      ...
                                      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td className="px-6 py-4 font-[500]">
                                          <div className="w-[240px]">
                                            <h4 className="font-[600] text-[14px] text-gray-800">
                                              {item?.productTitle}
                                            </h4>
                                            ...
                                            <div className="flex flex-wrap gap-2 mt-2">
                                              {item?.size !== "" &&
                                                item?.size !== undefined && (
                                                  <span className="bg-blue-100 text-blue-700 px-2 py-1 rounded-md text-[11px] font-[600]">
                                                    Size : {item?.size}
                                                  </span>
                                                )}
                                              ...
                                              {item?.weight !== "" &&
                                                item?.weight !== undefined && (
                                                  <span className="bg-green-100 text-green-700 px-2 py-1 rounded-md text-[11px] font-[600]">
                                                    Weight : {item?.weight}
                                                  </span>
                                                )}
                                              ...
                                              {item?.ram !== "" &&
                                                item?.ram !== undefined && (
                                                  <span className="bg-purple-100 text-purple-700 px-2 py-1 rounded-md text-[11px] font-[600]">
                                                    RAM : {item?.ram}
                                                  </span>
                                                )}
                                            </div>
      ...
      <div className="card my-4 shadow-md sm:rounded-lg bg-white">
        ...
        <div className="px-5 overflow-x-scroll">
          {chartData?.length !== 0 && (
            <BarChart
              width={
                context?.windowWidth > 920 ? context?.windowWidth - 350 : 800
              }
              height={500}
              data={chartData}
              margin={{
