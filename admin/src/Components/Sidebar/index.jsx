...
const Sidebar = () => {
  ...
  return (
    <>
      <div
        className={`sidebar fixed top-0 left-0 z-[52] bg-[#fff] h-full border-r border-[rgba(0,0,0,0.1)] py-2 px-4 w-[${context.isSidebarOpen === true ? `${20}%` : "0px"}]`}
      >
        <div
              ...
              <ul className="w-full">
                ...
                <li className="w-full">
                  <Button
                    ...
                    onClick={() => navigate("/homeslider/add")}
                  >
                    <span className="block w-[5px] h-[5px] rounded-full bg-[rgba(0,0,0,0.2)]"></span>
